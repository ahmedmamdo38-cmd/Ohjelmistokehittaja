    ...
    public partial class AvainhenkilotFM : Form
    {
       ...
       // private void vastuuhloCB_TextChanged(object sender, EventArgs e)
        ...
        private void taytaOppilaitosTaulukko()
        {
            ...
            oppilaitos.Rows.Add(2, "Omnia", "Armas Laniksen katu 9", "02650", "Espoo", "046 877 1371");
            oppilaitos.Rows.Add(3, "Varia", "Rälssitie 13", "01530", "Vantaa", "040 182 4668");
            oppilaitos.Rows.Add(4, "Kauda", "Sibeliuksenväylä 55 A", "04400", "Järvenpää", "09 27 381");
        }
        ...
        private void taytaVastuuHenkilotTaulukko()
        {
            ...
            vastuuHenkilot.Rows.Add(1, "Sirpa Lindroos", "Rehtori", "Kampus", "sirpa.lindroos@hel.fi", "050 540 4434");
